...
- Split the workbench UI into typed modules and focused components in commit `def7951`, moving transport, reducer, render helpers, and workbench CSS out of the old monolithic `ScenarioApp.tsx`.
